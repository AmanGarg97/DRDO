...
$user_registration_query1 = "insert into students(first_name,last_name,enroll_id,b_day,father_name,mother_name,address,state,pin_code,phone,email_id) values('$first_name' , '$last_name' , '$enroll_id' , '$b_date'  , '$fname' , '$mname' , '$add' , '$city' , '$pincode' , '$phone' , '$email')" or
...
echo "User Succesfully Inserted haha";
